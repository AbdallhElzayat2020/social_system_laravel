                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"
                               ...
                               id="role_name"
                               name="role_name"
                               value="{{ old('role_name',$authorization->role_name) }}"
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('status') is-invalid @enderror"
                            ...
                            <option value="active" @selected(old('status', $authorization->status) == 'active' )>Active</option>
                            <option value="inactive" @selected(old('status', $authorization->status) == 'inactive' )>Inactive</option>
                        </select>
                        @error('status')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                            ...
                            @foreach(config('authorizations.permissions') as $key => $value)
                                <div class="permission-item">
                                    ...
                                    <input type="checkbox"
                                           ...
                                           name="permissions[]"
                                           value="{{ $key }}"
                                           {{ in_array($key, old('permissions', $authorization->permissions)) ? 'checked' : '' }}
